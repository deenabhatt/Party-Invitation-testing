...
def is_mel(name, email):
    ...
    >>> is_mel('Mel Melitpolski', 'abcmel@ubermelon.com')
    True
    >>> is_mel('abdnMel Melitpolski', 'mel@ubermelon.com')
    True
    >>> is_mel('xvrzl Melitpolski', 'xvrzl@ubermelon.com')
    False
    >>> is_mel('Mel', 'mel@ubermelon.com')
    True
    >>> is_mel('Mel ', 'xyz@ubermelon.com')
    False"""
